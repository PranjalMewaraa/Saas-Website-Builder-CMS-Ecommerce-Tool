...
import ProductListV1 from "../ProductList/ProductListV1";
...
> = {
  ...
  "ProductList/V1": {
    ...
    render: (props: any) => {
      if (props.__editor) {
        return React.createElement(ProductListVisualStub, props);
      }
      return React.createElement(ProductListV1 as any, props);
    },
  },
  ...
  "ProductDetail/V1": {
    ...
    render: (props: any) => {
      if (props.__editor) {
        return React.createElement(ProductDetailVisualStub, props);
      }
