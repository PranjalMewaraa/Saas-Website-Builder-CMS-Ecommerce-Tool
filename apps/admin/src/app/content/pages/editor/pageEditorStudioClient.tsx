          ...
          <>
            {mode === "json" ? (
              ...
              <div className="grid h-[calc(100vh-20px)] gap-4 min-h-0 grid-cols-[320px_minmax(0,1fr)] overflow-y-hidden">
                <div className="flex flex-col h-full min-h-0 bg-slate-50 border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
                  {/* 1. Header & Primary Navigation */}
                  <div className="bg-white border-b border-slate-200 p-3 pb-2 space-y-3">
                    <Toolbar
                      showGrid={showGrid}
                    ...
                    <div className="flex bg-slate-100 p-1 rounded-xl">
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 rounded-lg px-3 py-1.5 text-xs font-bold transition-all ${
                          leftPanelTab === "layers"
                        ...
                        <div className="space-y-1.5">
                          {blocks.map((b: any) => (
                            <div
                              ...
                              className={`group cursor-grab active:cursor-grabbing rounded-xl border px-3 py-2.5 transition-all ${
                                selection?.blockId === b.id
                                  ? "bg-white border-blue-500 shadow-sm ring-1 ring-blue-500/10"
                                  : "bg-white/90 shadow-xs border-transparent hover:bg-white hover:border-slate-300"
                              }`}
                            >
                              <div className="flex items-center justify-between gap-2">
                                ...
                                <button
                                  type="button"
                                  className="opacity-0 group-hover:opacity-100 text-[10px] font-bold text-slate-400 hover:text-blue-600 px-1.5 py-0.5 rounded transition-all"
                                  onClick={(e) => {
                                    e.stopPropagation();
                  ...
                  <div className="p-3 bg-white border-t border-slate-200">
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm active:scale-[0.98] ${
                        saveStatus === "success"
