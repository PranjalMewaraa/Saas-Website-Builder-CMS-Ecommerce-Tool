...
export function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full min-w-0">
      ...
      <input
        className="w-full bg-surface border border-line rounded-control px-3 py-2 text-sm text-ink
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full min-w-0">
      ...
      <div className="group flex items-stretch bg-surface border border-line rounded-control overflow-hidden transition-all duration-200 focus-within:border-accent focus-within:ring-2 focus-within:ring-accent">
        <input
          className="w-full px-3 py-2 text-sm font-mono text-ink focus:outline-none placeholder:text-muted"
          value={text}
          onChange={(e) => {
...
export function TextArea({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full min-w-0">
      ...
      <textarea
        className="w-full bg-surface border border-line rounded-control px-3 py-2 text-sm text-ink min-h-[100px]
                   transition-all duration-200 resize-y placeholder:text-muted
                   hover:border-muted/40 focus:border-accent focus-visible:ring-2 focus-visible:ring-accent focus:outline-none"
        value={value ?? ""}
        onChange={(e) => onChange(e.target.value)}
      />
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative group min-w-0">
        <select
          className="w-full min-w-0 appearance-none bg-surface border border-line rounded-control px-4 py-2.5 text-sm text-ink
...
export function VisualInspector({
  ...
  function renderResetLink(path: string) {
    ...
    return (
      <button
        ...
        className="text-[10px] font-medium text-muted hover:text-ink"
      >
        Use inherited value
      </button>
    );
  ...
  const Section = ({
    ...
    return (
      <div className="border border-line rounded-control bg-surface">
        <button
          type="button"
    ...
    <div className="space-y-6">
      ...
      {showAnyStyleControls ? (
        <div className="border-t pt-4 space-y-4">
          ...
          <div className="rounded-card border border-line bg-canvas px-3 py-3 text-sm">
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-full bg-surface px-2 py-0.5 text-[11px] font-semibold text-ink ring-1 ring-line">
                    {breakpointLabel}
                  </span>
                  {styleBreakpoint !== "desktop" ? (
              ...
              {styleBreakpoint !== "desktop" ? (
                <button
                  ...
                  className="shrink-0 rounded-control border border-line bg-surface px-3 py-1.5 text-[11px] font-semibold text-muted hover:border-muted/40 hover:text-ink"
                >
